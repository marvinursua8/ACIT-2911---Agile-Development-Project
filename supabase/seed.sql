...
INSERT INTO "public"."animals" ("id", "name", "species", "breed", "gender", "age", "size", "color", "house_trained", "description", "adopted") VALUES
	(1, 'Robin', 'Dog', 'Dachshund', 'Male', 9, 'medium', 'brown', 'House trained', 'Marvin''s dog yaaaaaaaaaaay', false),
	(55, 'Roxy', 'Goby', 'Unknown', 'female', 2, 'small', 'Brown', 'Not house trained', 'Glop glop', false),
	...
	(128, 'Felix', 'Cat', 'Unknown', 'male', 5, 'small', 'White', 'House trained', 'Likes to sneak around', false),
	(132, 'Gerald II', 'Cat', 'British Shorthair', 'Male', 11, 'small', 'Gray', 'Not house trained', 'Adopt him or else', false),
	(130, 'Joe', 'Dog', 'Unknown', 'Male', 4, 'large', 'brown', 'House trained', 'Woof', false),
	(2, 'Rocco', 'Dog', 'German Shepard', 'Male', 7, 'large', 'light brown', 'House trained', 'Will protecc', false);
